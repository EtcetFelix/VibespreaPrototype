...
internal class Crypto {
    ...
    static func decrypt(data: Data, mic: Data, keys: (sessionKey: Data, sessionNonce: Data, deviceKey: Data)) -> Data? {
        return Crypto.calculateDecryptedCCM(data, withKey: keys.sessionKey, nonce: keys.sessionNonce, andMIC: mic, withAdditionalData: nil)
    }
}
